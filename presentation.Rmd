...
- How can you ensure that your code works on someone elses machine?
- How and why should you implement version control?
- Simplifying work through functions and modulating code.
- Creating your outputs in R Markdown

## R Projects

Code such as the following makes your code instantly not reproducible:
...
To ensure that this never happens you should be using **[R Projects](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects)**. 

These do the following:

- Create 1 folder where all of your projects analysis is stored.
- Makes the working directory of R that folder.

For another analyst to pick up your work they simply open the .Rproj file which opens the project environment in R Studio.

## Project Structure

Now you have a folder to store all of your R scripts it is useful to make some common folders that are standard across multiple projects. 

A simple example of these is as follows:
...
2. Load all your packages and data sets required in a script at the top of the script. 
3. Break your code down into separate files so that each file has a specific use. 
